...
class VBEPostings:
    ...
    def vb_decode(encoded_bytestream):
        ...
        """
        # TODO
        # decoded_bytesream = list()
        # decoded_bit = 0
        # for bytes in encoded_bytestream:
        #     if bytes >= 128:
        #         decoded_bit = 128 * (decoded_bit - 1) + bytes
        #         decoded_bytesream.insert(len(decoded_bytesream) - 1, (decoded_bit))
        #         decoded_bit = 0
        #     else:
        #         decoded_bit = 128 * decoded_bit + bytes
        # return decoded_bytesream
        # # return 0
        ...
        for i in decoded_bytestream_list:
            if i >= 128:
                n = 128*n+(i-128)
                decoded.append(n)
                n = 0
    ...
    def decode(encoded_postings_list):
        ...
        gbl = VBEPostings.vb_decode(encoded_postings_list) #gap based list
        pl = gbl.copy() # postings list
