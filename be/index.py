...
class InvertedIndexReader(InvertedIndex):
    ...
    def get_postings_list(self, term):
        ...
        start_position_in_index_file , number_of_postings_in_list, length_in_bytes_of_postings_list, tf_length = self.postings_dict[term]
...
class InvertedIndexWriter(InvertedIndex):
    ...
    def append(self, term, postings_list, tf_list):
        ...
        if self.terms != []:
            ...
            start_position + len_pl + len_tfl, len(postings_list), len(encoded_pl), len(encoded_tfl))
        else:
